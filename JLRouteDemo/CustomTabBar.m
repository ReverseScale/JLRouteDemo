...
- (void)initData {
     //控制器数组(不需要导入控制器头文件)
     self.controllerArray = @[@"ModuleAMainViewController",@"ModuleBMainViewController"];
     //title数组
     self.titleArray = @[@"ModuleA",@"ModuleB"];
     //默认图片数组
     self.imageArray = @[@"home_tabbar",@"msg_tabbar"];
     //选中图片数组
     self.selImageArray = @[@"home_tabbar_sel",@"msg_tabbar_sel"];
     //tabBar高度
